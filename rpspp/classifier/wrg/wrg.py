# Code FROM https://github.com/sambaiga/WRG-NILM/blob/master/src/utils/utils.py
...
def generate_input_feature(current, voltage, image_type, width, eps=None, delta=None, multi_dimension=True, p=1):
    """[summary]
    ...
    Keyword Arguments:
        multi_dimension {bool} -- [description] (default: {True})
...
def get_weighted_reccurrence_graph(dist, eps, delta):
    """[summary]
